#!/usr/bin/env python3
"""
Test script for penetration analysis using the q2D_analyzer class.
...
def test_penetration():
    ...
    for key, value in structures.items():
        ...
        axial_positions = analyzer.calculate_penetration_of_molecule_in_octahedra()
        print(f"Axial positions in {key}: {axial_positions}")