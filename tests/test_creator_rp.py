...
def main():
    ...
    glazer_cases_rp_reduced = [
        ("rp_glazer_a0a0c+_reduced", [0, 0, 20], ["0", "0", "+"], 1, (1, 1, 1), "CCCCC[NH3+]", 0.5, None),
        ("rp_glazer_a0b+b+_reduced", [0, 1.5, 10], ["0", "+", "+"], 2, (1, 1, 2), "[NH3+]CCCCCCC", [-0.4, 0.4], None),
        ("rp_glazer_a-a-a-_reduced", [1.5, 1.5, 15], ["-", "-", "-"], 3, (2, 2, 2), "[NH3+]CCCCCCCCC=O", 0.3, None),
        ("rp_double-_reduced", [0, 2.5, 5], ["0", "-", "-"], 4, (1, 1, 5), ["C=CCC=CCC[NH3+]", "CN1C=NC2=C1C(=O)N(C(=O)N2C)CC[NH3+]"], 0.7, None),
        ("rp_glazer_a+b-c-_reduced", [3, 2, 6], ["+", "-", "-"], 5, (1, 1, 3), "CCC=C[NH3+]", 0.0, None),
        ("rp_glazer_atomic_reduced", [3, 2, 6], ["+", "-", "-"], 5, (1, 1, 3), "Cs", -0.5, None),
        ("rpdj_reduced", [0, 2.5, 5], ["0", "-", "-"], 4, (1, 1, 5), ["C=CCC=CCC[NH3+]", "[NH3+]CCCC[NH3+]"], 0.0, "L2-M1-RP1-RP2-RP1-M1"),
    ]
