...
if MATPLOTLIB_AVAILABLE:
    ...
    if STYLE_AVAILABLE:
        style_axes(ax)
        save_figure(fig, IMAGES / "rdf_single_pair.png")
    else:
        plt.tight_layout()
        plt.savefig(IMAGES / "rdf_single_pair.png", dpi=300, bbox_inches='tight')
        plt.close()
    print("✓ Created rdf_single_pair.png")
    ...
    if STYLE_AVAILABLE:
        style_axes(ax)
        save_figure(fig, IMAGES / "rdf_multiple_pairs.png")
    else:
        plt.tight_layout()
        plt.savefig(IMAGES / "rdf_multiple_pairs.png", dpi=300, bbox_inches='tight')
        plt.close()
    print("✓ Created rdf_multiple_pairs.png")
...
if MATPLOTLIB_AVAILABLE:
    ...
    if angles is not None and len(angles) > 0:
        ...
        if STYLE_AVAILABLE:
            style_axes(ax)
            save_figure(fig, IMAGES / "bxb_angles_histogram.png")
        else:
            plt.tight_layout()
            plt.savefig(IMAGES / "bxb_angles_histogram.png", dpi=300, bbox_inches='tight')
            plt.close()
        print("✓ Created bxb_angles_histogram.png")
    ...
    if len(xbx_angles) > 0:
        ...
        if STYLE_AVAILABLE:
            style_axes(ax)
            save_figure(fig, IMAGES / "xbx_angles_histogram.png")
        else:
            plt.tight_layout()
            plt.savefig(IMAGES / "xbx_angles_histogram.png", dpi=300, bbox_inches='tight')
            plt.close()
        print("✓ Created xbx_angles_histogram.png")
    ...
    if len(bond_lengths) > 0:
        ...
        if STYLE_AVAILABLE:
            style_axes(ax)
            save_figure(fig, IMAGES / "bx_bond_lengths_histogram.png")
        else:
            plt.tight_layout()
            plt.savefig(IMAGES / "bx_bond_lengths_histogram.png", dpi=300, bbox_inches='tight')
            plt.close()
        print("✓ Created bx_bond_lengths_histogram.png")
    ...
    if STYLE_AVAILABLE:
        style_axes(ax)
        save_figure(fig, IMAGES / "all_distances_histogram.png")
    else:
        plt.tight_layout()
        plt.savefig(IMAGES / "all_distances_histogram.png", dpi=300, bbox_inches='tight')
        plt.close()
    print("✓ Created all_distances_histogram.png")
...
if MATPLOTLIB_AVAILABLE:
    ...
    plt.tight_layout()
    plt.savefig(IMAGES / "graph_structure_overview.png", dpi=300, bbox_inches='tight')
    plt.close()
    print("✓ Created graph_structure_overview.png")
    ...
    plt.tight_layout()
    plt.savefig(IMAGES / "graph_octahedra_network.png", dpi=300, bbox_inches='tight')
    plt.close()
    print("✓ Created graph_octahedra_network.png")
    ...
    plt.tight_layout()
    plt.savefig(IMAGES / "graph_layer_structure.png", dpi=300, bbox_inches='tight')
    plt.close()
    print("✓ Created graph_layer_structure.png")
...
if RDKIT_AVAILABLE and MATPLOTLIB_AVAILABLE:
    ...
    if dj_mol:
        ...
        img = Draw.MolToImage(dj_mol, size=(600, 400))
        img.save(IMAGES / "validator_dj_spacer.png", dpi=(300, 300))
        print("✓ Created validator_dj_spacer.png")
    ...
    if rp_mol:
        ...
        img = Draw.MolToImage(rp_mol, size=(400, 400))
        img.save(IMAGES / "validator_rp_spacer.png", dpi=(300, 300))
        print("✓ Created validator_rp_spacer.png")
    ...
    if mol:
        ...
        if pattern_mol:
            ...
            if matches:
                ...
                img = Draw.MolToImage(mol, size=(600, 400), highlightAtoms=highlight_atoms)
                img.save(IMAGES / "validator_pattern_matching.png", dpi=(300, 300))
                print("✓ Created validator_pattern_matching.png")
...
if MATPLOTLIB_AVAILABLE:
    ...
    if len(spacers) > 0:
        ...
        if backbone_indices:
            ...
            write(IMAGES / "backbone_structure.png", backbone_atoms, 
                 rotation=rotation_iso, show_unit_cell=0)
            print("✓ Created backbone_structure.png")
        ...
        if dihedrals:
            ...
            plt.tight_layout()
            plt.savefig(IMAGES / "backbone_dihedrals_plot.png", dpi=300, bbox_inches='tight')
            plt.close()
            print("✓ Created backbone_dihedrals_plot.png")
        ...
        if bond_lengths and bond_angles:
            ...
            plt.tight_layout()
            plt.savefig(IMAGES / "backbone_geometry.png", dpi=300, bbox_inches='tight')
            plt.close()
            print("✓ Created backbone_geometry.png")
...
if MATPLOTLIB_AVAILABLE:
    ...
    if STYLE_AVAILABLE:
        ...
        style_axes(ax4)
        style_axes(ax5)
        save_figure(fig, IMAGES / "distortion_complete_analysis.png")
    else:
        plt.savefig(IMAGES / "distortion_complete_analysis.png", dpi=300, bbox_inches='tight')
        plt.close()
    print("✓ Created distortion_complete_analysis.png")
    ...
    try:
        ...
        if len(layer_ids) > 0:
            ...
            plt.tight_layout()
            plt.savefig(IMAGES / "distortion_layer_comparison.png", dpi=300, bbox_inches='tight')
            plt.close()
            print("✓ Created distortion_layer_comparison.png")
    except Exception as e:
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig(IMAGES / "distortion_parameters_summary.png", dpi=300, bbox_inches='tight')
        plt.close()
        print("✓ Created distortion_parameters_summary.png")
    except Exception as e:
