...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`simcomat/q2D-Materials`](https://github.com/simcomat/q2D-Materials)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/q2D-Materials.git`
...
```shell
$ git remote add upstream https://github.com/simcomat/q2D-Materials.git
```
...
Python package template and adapted from [MolTools/CineMol](https://github.com/MolTools/CineMol).
They're free to reuse and modify as long as they're properly acknowledged.